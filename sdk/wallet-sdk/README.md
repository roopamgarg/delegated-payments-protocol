...
**Status:** Package scaffold + [API RFC](../../docs/rfc/dpp-wallet-sdk-api.md). Method bodies throw `not_implemented` until [AGE-36](https://github.com/roopamgarg/delegated-payments-protocol/issues)–[AGE-38](https://github.com/roopamgarg/delegated-payments-protocol/issues) land.
